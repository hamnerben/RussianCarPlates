...
with open('src/data/test.csv', mode='r', encoding='utf-8') as test_file:
    ...
    with open('src/data/min_baseline.csv', mode='w', encoding='utf-8', newline='') as submission_file:
        ...
        for test_row in test_reader:
            ...
            writer.writerow([plate_id, min_price])  # Write the mean price for each ID
