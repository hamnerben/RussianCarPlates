...
# Define parameter grid, only used when grid search is enabled
# param_grid = {
...
# Handle categorical data (region) using one-hot encoding
...
# # Scale numerical features (didnt end up being that helpful)
